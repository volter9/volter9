...
?>
Привет, данный пост посвящен перфекционистам как я.

Бывало у тебя такое что когда пишешь PHP/Twig шаблоны в итоге вывод получается 
что-то вроде такого?:
...
<?php echo spoiler_code(ob_get_clean(), 'html') ?>
