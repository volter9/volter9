...
**UPD**: CMS из этой крутой статьи теперь на [GitHub](https://github.com/volter9/8-cms).

PHP &mdash; это такой мощный язык программирования на котором можно написать какой-угодно 
...
PHP &mdash; это самый крутой язык программирования на планете.
...
Я вот написал, а ты следуюешь за мной?
...
P.S.: 8 строчек PHP кода. Контент, .htaccess конфиг, и шаблоны не идут в счет строчек.
Только index.php
