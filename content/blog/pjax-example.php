...
относится для статических сайтов вроде моего).
...
В итоге вычислилось что все работает, но в исходном коде содержимое AJAX запроса 
...
т.е. "как запустить PJAX на чистом веб-сервере".
